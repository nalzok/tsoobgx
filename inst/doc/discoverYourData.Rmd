---
title: "Understand your dataset with tsoobgX"
output:
...
Understand your dataset with tsooBGX
====================================

Introduction
------------

The purpose of this vignette is to show you how to use **tsoobgX** to discover and understand your own dataset better.

This vignette is not about predicting anything (see [tsoobgX presentation](https://github.com/dmlc/tsoobgx/blob/master/R-package/vignettes/tsoobgxPresentation.Rmd)). We will explain how to use **tsoobgX** to highlight the *link* between the *features* of your data and the *outcome*.
...
**tsoobgX** manages only `numeric` vectors.
...
The code below is very usual. For more information, you can look at the documentation of `tsoobgx` function (or at the vignette [tsoobgX presentation](https://github.com/dmlc/tsoobgx/blob/master/R-package/vignettes/tsoobgxPresentation.Rmd)).
...
If you want to try Random Forests™ algorithm, you can tweak tsoobgX parameters!
