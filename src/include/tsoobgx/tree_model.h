 ...
 * \author Tianqi Chen
 */
#ifndef TSOOBGX_TREE_MODEL_H_
#define TSOOBGX_TREE_MODEL_H_
 ...
 *  This is the data structure used in tsoobgx's major tree models.
 */
class RegTree {
 public:
  ...
  class Node {
   public:
    ...
    TSOOBGX_DEVICE int LeftChild() const {
      return this->cleft_;
    }
    /*! \brief index of right child */
    TSOOBGX_DEVICE int RightChild() const {
      return this->cright_;
    }
    /*! \brief index of default child when feature is missing */
    TSOOBGX_DEVICE int DefaultChild() const {
      return this->DefaultLeft() ? this->LeftChild() : this->RightChild();
    }
    /*! \brief feature index of split condition */
    TSOOBGX_DEVICE unsigned SplitIndex() const {
      return sindex_ & ((1U << 31) - 1U);
    }
    /*! \brief when feature is unknown, whether goes to left child */
    TSOOBGX_DEVICE bool DefaultLeft() const {
      return (sindex_ >> 31) != 0;
    }
    /*! \brief whether current node is leaf node */
    TSOOBGX_DEVICE bool IsLeaf() const {
      return cleft_ == -1;
    }
    /*! \return get leaf value of leaf node */
    TSOOBGX_DEVICE bst_float LeafValue() const {
      return (this->info_).leaf_value;
    }
    /*! \return get split condition of the node */
    TSOOBGX_DEVICE SplitCondT SplitCond() const {
      return (this->info_).split_cond;
    }
    /*! \brief get parent of the node */
    TSOOBGX_DEVICE int Parent() const {
      return parent_ & ((1U << 31) - 1);
    }
    /*! \brief whether current node is left child */
    TSOOBGX_DEVICE bool IsLeftChild() const {
      return (parent_ & (1U << 31)) != 0;
    }
    /*! \brief whether this node is deleted */
    TSOOBGX_DEVICE bool IsDeleted() const {
      return sindex_ == std::numeric_limits<unsigned>::max();
    }
    /*! \brief whether current node is root */
    TSOOBGX_DEVICE bool IsRoot() const { return parent_ == -1; }
    /*!
     * \brief set the left child
     * \param nid node id to right child
     */
    TSOOBGX_DEVICE void SetLeftChild(int nid) {
      this->cleft_ = nid;
    }
    /*!
     ...
     * \param nid node id to right child
     */
    TSOOBGX_DEVICE void SetRightChild(int nid) {
      this->cright_ = nid;
    }
    /*!
     ...
     */
    TSOOBGX_DEVICE void SetSplit(unsigned split_index, SplitCondT split_cond,
     ...
     */
    TSOOBGX_DEVICE void SetLeaf(bst_float value, int right = -1) {
      (this->info_).leaf_value = value;
      this->cleft_ = -1;
      this->cright_ = right;
    }
    /*! \brief mark that this node is deleted */
    TSOOBGX_DEVICE void MarkDelete() {
      this->sindex_ = std::numeric_limits<unsigned>::max();
    }
    /*! \brief Reuse this deleted node. */
    TSOOBGX_DEVICE void Reuse() {
      this->sindex_ = 0;
    }
    // set parent
    TSOOBGX_DEVICE void SetParent(int pidx, bool is_left_child = true) {
