 ...
 * \author Tianqi Chen
 */
#ifndef TSOOBGX_TREE_UPDATER_H_
#define TSOOBGX_TREE_UPDATER_H_
 ...
 * TSOOBGX_REGISTER_TREE_UPDATER(ColMaker, "colmaker")
 ...
 * \endcode
 */
#define TSOOBGX_REGISTER_TREE_UPDATER(UniqueId, Name)                   \
  static DMLC_ATTRIBUTE_UNUSED ::tsoobgx::TreeUpdaterReg&               \
  __make_ ## TreeUpdaterReg ## _ ## UniqueId ## __ =                    \
      ::dmlc::Registry< ::tsoobgx::TreeUpdaterReg>::Get()->__REGISTER__(Name)

}  // namespace tsoobgx
#endif  // TSOOBGX_TREE_UPDATER_H_
