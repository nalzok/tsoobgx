 ...
 * \author Tianqi Chen
 */
#ifndef TSOOBGX_GBM_H_
#define TSOOBGX_GBM_H_
 ...
 * \endcode
 */
#define TSOOBGX_REGISTER_GBM(UniqueId, Name)                            \
  static DMLC_ATTRIBUTE_UNUSED ::tsoobgx::GradientBoosterReg &          \
  __make_ ## GradientBoosterReg ## _ ## UniqueId ## __ =                \
      ::dmlc::Registry< ::tsoobgx::GradientBoosterReg>::Get()->__REGISTER__(Name)

}  // namespace tsoobgx
#endif  // TSOOBGX_GBM_H_
