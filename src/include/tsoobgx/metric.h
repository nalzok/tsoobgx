 ...
 * \file metric.h
 * \brief interface of evaluation metric function supported in tsoobgx.
 * \author Tianqi Chen, Kailong Chen
 */
#ifndef TSOOBGX_METRIC_H_
#define TSOOBGX_METRIC_H_
 ...
 * TSOOBGX_REGISTER_METRIC(RMSE, "ndcg")
 ...
 * \endcode
 */
#define TSOOBGX_REGISTER_METRIC(UniqueId, Name)                         \
  ::tsoobgx::MetricReg&  __make_ ## MetricReg ## _ ## UniqueId ## __ =  \
      ::dmlc::Registry< ::tsoobgx::MetricReg>::Get()->__REGISTER__(Name)
}  // namespace tsoobgx
#endif  // TSOOBGX_METRIC_H_
