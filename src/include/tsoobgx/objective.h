 ...
 * \file objective.h
 * \brief interface of objective function used by tsoobgx.
 * \author Tianqi Chen, Kailong Chen
 */
#ifndef TSOOBGX_OBJECTIVE_H_
#define TSOOBGX_OBJECTIVE_H_
 ...
 * \endcode
 */
#define TSOOBGX_REGISTER_OBJECTIVE(UniqueId, Name)                      \
  static DMLC_ATTRIBUTE_UNUSED ::tsoobgx::ObjFunctionReg &              \
  __make_ ## ObjFunctionReg ## _ ## UniqueId ## __ =                    \
      ::dmlc::Registry< ::tsoobgx::ObjFunctionReg>::Get()->__REGISTER__(Name)
}  // namespace tsoobgx
#endif  // TSOOBGX_OBJECTIVE_H_
