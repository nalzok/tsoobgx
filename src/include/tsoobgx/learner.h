 ...
 *  This is the user facing tsooBGX training module.
 * \author Tianqi Chen
 */
#ifndef TSOOBGX_LEARNER_H_
#define TSOOBGX_LEARNER_H_
 ...
 *  This is the user facing module of tsoobgx training.
