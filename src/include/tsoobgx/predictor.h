...
#define TSOOBGX_REGISTER_PREDICTOR(UniqueId, Name)      \
  static DMLC_ATTRIBUTE_UNUSED ::tsoobgx::PredictorReg& \
      __make_##PredictorReg##_##UniqueId##__ =          \
          ::dmlc::Registry<::tsoobgx::PredictorReg>::Get()->__REGISTER__(Name)
}  // namespace tsoobgx
