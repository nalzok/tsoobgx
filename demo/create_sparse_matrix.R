...
# According to its documentation, tsoobgX works only on numbers.
...
#
# In this demo we will see how to transform a dense dataframe with categorical variables to a sparse matrix before analyzing it in tsoobgX.
...
cat("Learning...\n")
bst <- tsoobgx(data = sparse_matrix, label = output_vector, max_depth = 9,
