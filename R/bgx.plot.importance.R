...
#'
#' @param importance_matrix a \code{data.table} returned by \code{\link{bgx.importance}}.
...
#' @export
bgx.plot.importance <- function(importance_matrix = NULL, top_n = NULL, measure = NULL,
