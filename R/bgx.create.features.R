...
#' new.features.train <- bgx.create.features(model = bst, agaricus.train$data)
#' new.features.test <- bgx.create.features(model = bst, agaricus.test$data)
#' 
...
#' 
#' @export
bgx.create.features <- function(model, data, ...){
  check.deprecation(...)
